...
train_dir = "data/processed/species_enhanced"
img_size = (224, 224)
batch_size = 64
num_classes = 23
...
x = Dropout(0.5)(x)  # Slightly higher to align train/val
...
model.save("models/marine_species_model_90_perfect.h5")
